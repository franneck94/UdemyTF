...
if not os.path.exists(log_dir):
    os.mkdir(log_dir)
log_dir_model1 = os.path.join(log_dir, "model1")
...
model.add(Dense(units=300, kernel_initializer=init_w, bias_initializer=init_b, input_shape=(num_features,),))
...
tb = TensorBoard(log_dir=log_dir_model1, histogram_freq=1, write_graph=True)
